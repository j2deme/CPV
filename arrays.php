...
$colores = array('Rojo','Azul','Verde','Blanco','Negro','Cafe Oscuro','Cafe Arena','Plata/Cromado','Gris','Naranja','Morado/Violeta','Amarillo');
$tipos = array('Automóvil','Camioneta','Motocicleta');
$carreras = array('IGE','IIA','II','ISC','IA','ITIC');
?>
